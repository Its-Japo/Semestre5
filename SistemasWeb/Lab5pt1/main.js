...
paddingtonName.style.color = "white";
paddingtonName.innerHTML = "Paddington";
...
mensajeChat.class = "mensaje-chat";
mensajeChat.style.width = "90%";
mensajeChat.style.height = "90%";
mensajeChat.placeholder = "Escribe un mensaje...";
mensajeChat.placeholder.color = "white";

mensajeChat.style.backgroundColor = colorCuaternario;
mensajeChat.style.color = "white";
